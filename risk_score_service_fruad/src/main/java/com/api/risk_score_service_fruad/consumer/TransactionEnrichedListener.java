package com.api.risk_score_service_fruad.consumer;

import com.api.risk_score_service_fruad.event.TransactionScoredEvent;
import com.api.risk_score_service_fruad.service.RiskRuleEngine;
...
public class TransactionEnrichedListener {
    ...
    public void onMessage(
        ...
        try {
            ...
            var enriched = objectMapper.readTree(record.value());
            ...
            String payload = objectMapper.writeValueAsString(scoredEvent);
